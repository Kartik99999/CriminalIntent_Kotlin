...
import com.kartik.criminalintent.database.CrimeCursorWrapper;
import com.kartik.criminalintent.database.CrimeDbSchema.CrimeTable;
import static com.kartik.criminalintent.database.CrimeDbSchema.CrimeTable.Cols.*;
...
public class CrimeLab {
    ...
    private static ContentValues getContentValues(Crime crime) {
        ...
        values.put(SOLVED, crime.getSolved() ? 1 : 0);
        return values;
    }
